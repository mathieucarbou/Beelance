...
void Beelance::BeelanceClass::_initConfig() {
  ...
  config.configure(KEY_HX711_CLOCK_PIN, String(BEELANCE_HX711_CLOCK_PIN).c_str());
  config.configure(KEY_HX711_DATA_PIN, String(BEELANCE_HX711_DATA_PIN).c_str());
  ...
  config.configure(KEY_MODEM_GPS_SYNC_TIMEOUT, String(MYCILA_MODEM_GPS_SYNC_TIMEOUT).c_str());
  ...
  config.configure(KEY_TEMPERATURE_PIN, String(BEELANCE_TEMPERATURE_PIN).c_str());
